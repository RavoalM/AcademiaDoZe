...
public class Colaborador : Pessoa
{
    ...
    public static Result<Colaborador> Criar(int id, string nome, string cpf, DateOnly dataNascimento, string telefone, string email,
     Logradouro logradouro, string numero, string complemento, string senha, Arquivo? foto, DateOnly dataAdmissao, ColaboradorTipo tipo,
     ColaboradorVinculo vinculo)
    {
        ...
        var colaborador = new Colaborador(id, nome, cpfResult.Value!, dataNascimento, telefoneResult.Value!, emailResult.Value!,
