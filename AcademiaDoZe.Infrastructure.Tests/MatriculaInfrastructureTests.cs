...
public class MatriculaInfrastructureTests : TestBase
{
        ...
        Arquivo? laudo = null)
    {
        ...
        id: 0, aluno: aluno, plano: plano, dataInicio: inicio, objetivo: "Alvaro Feltrin", restricoesMedicas: restricoes, laudoMedico: laudo, observacoesRestricoes: obsRestricao
        );
    ...
    public async Task Matricula_RestricoesMedicas_ComVariacoesMultiplaEscolha_PersisteEObtemCorretamente()
    {
        ...
        // GAmbeta da escolha multipla (Pressão Alta + Labirintite + Problemas Respiratórios + Remédio Contínuo)
