...
public class ValueObjectsTests
{
    ...
    [Theory(DisplayName = "Cep: caracteres inválidos")]
    [InlineData("ABCDEFGH")]
    [InlineData("12345ABC")]
    [InlineData("1234@678")]
    public void Deve_Falhar_Criacao_Quando_CepPossuirCaracteresInvalidos(string input)
    {
        var result = Cep.Criar(input);
    ...
    public void Deve_Falhar_Criacao_Quando_TelefonePossuirQuantidadeInvalidaDeDigitos(string input)
    {
        var result = Telefone.Criar(input);
