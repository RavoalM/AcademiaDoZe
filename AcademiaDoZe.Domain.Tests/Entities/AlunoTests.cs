...
public class AlunoTests
{
    ...
    {
        var result = Aluno.Criar(1,nome,"529.982.247-25",DateOnly.FromDateTime(DateTime.Today.AddYears(-25)),"(11) 91234-5678","user@example.com",
    ...
    [Theory(DisplayName = "Aluno: cpf vazio -> CPF_OBRIGATORIO")]
    [InlineData("")]
    [InlineData(" ")]
    ...
    [Theory(DisplayName = "Aluno: telefone vazio -> TELEFONE_OBRIGATORIO")]
    [InlineData("")]
    [InlineData(" ")]
